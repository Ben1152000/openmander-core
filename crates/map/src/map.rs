...
impl Map {
    ...
    #[inline] pub fn get_layer_mut(&mut self, ty: GeoType) -> &mut MapLayer { &mut self.layers[ty as usize] }
    ...
    #[inline] pub fn get_layers_mut(&mut self) -> &mut [MapLayer; GeoType::COUNT] { &mut self.layers }
